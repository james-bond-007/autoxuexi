...
class XUEXI:
    def __init__(self, use_Dingtalk=False):
        ...
        if os.path.exists('./driver/chromedriver'):
            ...
            try:
                ...
                while not self.__exit_flag.isSet():
                    ...
                    if u'scroll-done' in self.driver.title:
                        ...
                        self.__exit_flag.wait(random.randint(1, 3))
        ...
        for link in resp_list:
            try:
                ...
                if len(time_arr) == 2:
                    ...
                    video_duration = 0
                video_duration = random.randint(25, 90)
...
def pre_init():
    if not os.path.exists('./driver/chromedriver'):
        raise IOError('chromedriver not found')
